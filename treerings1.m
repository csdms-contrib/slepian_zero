function treerings1(diro,fname)
% TREERINGS1(diro,fame)
%
...
% EXAMPLE:
%
% treerings1('.',[]) % Current directory - default file
% treerings1([],' KJ10_barkup.tif') % Default directory, some file
% treerings1('/Volumes/home/fjsimons/','somefile') % You get the idea 
%
% Last modified by fjsimons-at-alum.mit.edu, 11/07/2019
